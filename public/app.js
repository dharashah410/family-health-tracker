...
const MEAL_PLAN = [
  ...
  { day: 'Monday', dayShort: 'Mon',
    ...
    S: { b: '3-egg scrambled eggs + Mediterranean Lentil Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Tuesday', dayShort: 'Tue',
    ...
    S: { b: '3-egg omelette + Quinoa Tabbouleh on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Wednesday', dayShort: 'Wed',
    ...
    S: { b: '3-egg half-fried eggs + Cauliflower Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Thursday', dayShort: 'Thu',
    ...
    S: { b: '3-egg scrambled eggs + Quinoa Salad with Chickpeas on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Friday', dayShort: 'Fri',
    ...
    S: { b: '3-egg omelette + Mediterranean Bean Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Saturday', dayShort: 'Sat',
    ...
    S: { b: 'Chocolate oat pancakes (with eggs) or oats porridge',
  ...
  { day: 'Monday', dayShort: 'Mon',
    ...
    S: { b: '3-egg scrambled eggs + Seaweed Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Wednesday', dayShort: 'Wed',
    ...
    S: { b: '3-egg half-fried eggs + Mediterranean Lentil Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Thursday', dayShort: 'Thu',
    ...
    S: { b: '3-egg scrambled eggs + Cauliflower Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Friday', dayShort: 'Fri',
    ...
    S: { b: '3-egg omelette + Quinoa Salad with Chickpeas on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Monday', dayShort: 'Mon',
    ...
    S: { b: '3-egg scrambled eggs + Edamame Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Tuesday', dayShort: 'Tue',
    ...
    S: { b: '3-egg omelette + Mediterranean Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Wednesday', dayShort: 'Wed',
    ...
    S: { b: '3-egg half-fried eggs + Stir Fry Vegetables on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Thursday', dayShort: 'Thu',
    ...
    D: { b: 'Bread Upma (large) + banana + peanut butter + seeds',
         ...
         d: '🫓 DOSA NIGHT — Red Rice Dosa ×3 + sambar + coconut chutney + avocado' },
    S: { b: '3-egg scrambled eggs + Capsicum-Mushroom-Palak Bowl on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Friday', dayShort: 'Fri',
    ...
    S: { b: '3-egg omelette + Thai Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Wednesday', dayShort: 'Wed',
    ...
    S: { b: '3-egg half-fried eggs + Seaweed Salad on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Thursday', dayShort: 'Thu',
    ...
    S: { b: '3-egg scrambled eggs + Quinoa Tabbouleh on the side (from Ritvij\'s lunch)',
  ...
  { day: 'Friday', dayShort: 'Fri',
    ...
    S: { b: '3-egg omelette + Mediterranean Lentil Salad on the side (from Ritvij\'s lunch)',
